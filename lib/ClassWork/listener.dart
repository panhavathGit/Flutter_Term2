...
class IPadDisplay implements WeatherListener {
  @override
  void onTemperatureChanged(double temperature) {
    print("📺 Ipad Display: Temperature updated to $temperature°C");
  }
}
...
void main() {
  ...
  IPadDisplay iPadDisplay = IPadDisplay();
  ...
  weatherStation.addListener(iPadDisplay);
  // Update temperature
